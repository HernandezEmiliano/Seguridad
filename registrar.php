...
{
	echo "<script> alert('Usuario registrado: $usu');window.location= 'login.html' </script>";
}
else 
{
...
{
		echo "<script> alert('No puedes registrar este correo: $correo');window.location= 'login.html' </script>";
}
