        ...
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                ...
                <div class="d-inline-flex align-items-center d-block d-lg-none">
                    ...
                    <a href="cartusuario.php" class="btn px-0 ml-2">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="usuario.php" class="text-decoration-none d-block d-lg-none">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="usuario.php" class="nav-item nav-link ">Inicio</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Categorias <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="xboxusuario.php" class="dropdown-item">Xbox</a>
                                    <a href="playstationusuario.php" class="dropdown-item">PlayStation</a>
                                    <a href="accesoriosusuarios.php" class="dropdown-item">Accesorios</a>
                                    <a href="switchusuario.php" class="dropdown-item">Switch</a>
                                    <a href="juegosusuarios.php" class="dropdown-item">Juegos</a>
                                </div>
                            </div>
                           
                            <a href="detailusuario.php" class="nav-item nav-link">Detalles Tienda</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Paginas <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="cartusuario.php" class="dropdown-item">Carro de Compras</a>
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Mi cuenta <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="cartusuario.php" class="btn px-0 ml-3">
