...
{
	echo "<script> alert('Informacion enviada');window.location= 'pagofinalusuario.php' </script>";
}else
{
	echo "<script> alert('Error');window.location= 'usuario.php' </script>";
}
}
else
{
	echo "<script> alert('Gracias por la compra');window.location= 'usuario.php' </script>";
}
